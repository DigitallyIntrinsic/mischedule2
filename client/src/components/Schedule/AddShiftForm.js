  ...
  const handleDropdownChange = (id, value) => {
    if (value) {
      ...
      const selectedPosition = sortedPositions.find(
        (position) => position.jobTitle === value
      );

      if (id === "user" && selectedUser) {
        setFormData({
          ...formData,
          [id]: { userId: selectedUser._id, userValue: value },
        });
      } else if (id === "position" && selectedPosition) {
        setFormData({
          ...formData,
          [id]: { positionId: selectedPosition._id, positionValue: value },
        });
      }
    }
  };
            ...
            <Form>
              ...
              <div className="row mb-3">
                <Form.Select
                  ...
                  onChange={(event) =>
                    handleDropdownChange("user", event.target.value)
                  }
                >
              ...
              <div className="row mb-3">
                <Form.Select
                  ...
                  onChange={(event) =>
                    handleDropdownChange("position", event.target.value)
                  }
                >
